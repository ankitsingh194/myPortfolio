...
const MernStackInfo = () => {
  ...
  return (
    <div className="min-h-screen  lg:ml-[30px]  flex flex-col items-center justify-center bg-white p-6 ">
        <h2 className="text-3xl font-bold text-orange-500 mb-8">Learn About the Tech Stack </h2>
        <div className=' w-[80%] ml-[-10px] lg:ml-[-40px]'>
      <div className={`grid gap-11   ${cards.length < 3 ? 'grid-cols-1 md:grid-cols-2 justify-center' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'}`}>
