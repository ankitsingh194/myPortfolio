...
const MernStackInfo = () => {
  ...
  return (
    <div className="min-h-screen   flex flex-col items-center justify-center bg-white p-6 mt-[-80px]">
        <h2 className="text-3xl font-bold text-orange-500 mb-8">Learn About the Tech Stack </h2>
        <div className=' w-[80%] ml-[-40px]'>
      <div className={`grid gap-11 ml-[2%] ${cards.length < 3 ? 'grid-cols-1 md:grid-cols-2 justify-center' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3'}`}>
